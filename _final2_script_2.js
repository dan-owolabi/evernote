        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Keep existing publish binding (openPublishModal set earlier).
            // Only attach preview fallback if no click handler was assigned.
            const saveShareBtn = document.getElementById('saveShareBtn');
            if (saveShareBtn && !saveShareBtn.onclick) {
